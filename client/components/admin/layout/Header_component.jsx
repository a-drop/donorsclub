Admin.Header = class AdminHeader extends React.Component {
  constructor(props) {
    super(props)
    ...
    return(
      ...
      <header className="main-header">
        ...
        <a href="index2.html" className="logo">
          ...
          <span className="logo-mini"><b>DC</b></span>
          {/* logo for regular state and mobile devices */}
          <span className="logo-lg"><b>Donors</b>Club</span>
          {/*<span className="logo-mini logo"><img src="/images/logo.svg" alt=""/></span>*/}

          {/*<span className="logo-lg logo"><img src="/images/logo.svg" alt=""/></span>*/}
                  ...
                  <li>
                    ...
                    <ul className="menu">
                      ...
                      <li>
                        <a href="#">
                          <div className="pull-left">
                            <img src="/images/user3-128x128.jpg" className="img-circle" alt="User Image" />
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div className="pull-left">
                            <img src="/images/user4-128x128.jpg" className="img-circle" alt="User Image" />
                          </div>
                          <h4>
                            Developers
